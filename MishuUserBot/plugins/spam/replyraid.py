...
async def raid(xspam: Client, e: Message):  
      MishuUserBot = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
...
#              return #remove # to enable this
          if int(id) in VERIFIED_USERS:
                ...
                text = f"Abe Lawde that guy part of Eternity Zain."
                await e.reply_text(text)
          else:
              fname = ok.first_name
